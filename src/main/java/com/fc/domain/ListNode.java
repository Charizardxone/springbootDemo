...
public class ListNode {
    ...
    public static ListNode mergeTwoLists(ListNode list1, ListNode list2) {
        ...
        if (arr.size() == 1) return new ListNode(arr.get(0));
    ...
    public static ListNode recursive(ListNode res, ListNode list1, ListNode list2) {
        ...
        if (list1.val <= list2.val) {
            if (next1 == null) {
                ...
                if (next1.val >= list2.val) {
                    list1.next = list2;
                    list2.next = next1;
                    recursive(res, next1, next2);
                } else {
                    recursive(res, next1, list2);
                }
            }
        } else {
            recursive(res, list1, next2);
        }
    ...
    public static int removeElement(int[] nums, int val) {
        ...
        long a = Arrays.stream(nums).filter(s -> s != val).count();
        if (a == 0) {
            return 0;
        }
        ...
        long count = Arrays.stream(nums).filter(s -> s != val).count();
        System.out.print("[");
        for (int num : nums) {
    ...
    public static ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        int i = 0, j = 0;
        res = add(res, i, j, l1, l2);

        String s = String.valueOf(res);

        ListNode node = new ListNode(Integer.valueOf(s.substring(s.length() - 1)));
        ListNode temp = node;

        for (int k = s.length() - 2; k >= 0; k--) {
            temp.next = new ListNode(Integer.valueOf(s.substring(k, k + 1)));
            temp = temp.next;
        }
    ...
    public static BigDecimal add(BigDecimal res, int i, int j, ListNode l1, ListNode l2) {
        BigDecimal a = BigDecimal.ZERO;
        if (l1 != null) {
            a = a.add(new BigDecimal(l1.val).multiply(BigDecimal.TEN.pow(i)));
            i++;
        }
        if (l2 != null) {
            a = a.add(new BigDecimal(l2.val).multiply(BigDecimal.TEN.pow(j)));
            j++;
        }
        if ((l1 == null || l1.next == null) && (l2 == null || l2.next == null)) {
            return a;
        } else {
            a = a.add(add(a, i, j, l1 == null ? null : l1.next, l2 == null ? null : l2.next));
        }
        return a;
    }
    ...
    public static List<String> aaa(int n, Map<Integer, List<String>> map) {
        if (n == 1) {
        ...
        if (map.containsKey(n - 1)) {
            ...
            for (String s : list) {
                ...
                while (m.find()) {
                    res.add(s.substring(0, m.start() + 1) + "()" + s.substring(m.end() - 1));
                }

                java.util.regex.Pattern pattern1 = java.util.regex.Pattern.compile("(?<=(\\())(\\(\\))+(?=(\\)))");
                java.util.regex.Matcher m1 = pattern1.matcher(s);
                while (m1.find()) {
                    res.add(s.substring(0, m1.end()) + "()" + s.substring(m1.end()));
                }
                // 包在两头
                res.add("(" + s + ")");
            }
            ArrayList<String> l = new ArrayList<>(res);
            map.put(n, l);
            return l;
        } else {
            aaa(n - 1, map);
...
//        }
    ...
    public static List<String> getCombinations(Map<String, List<String>> map, String digits) {
        ...
        List<String> list = getLetter(digits);
        map.put(digits, list);
        return list;
    }
...
//        while(i < j) res = Math.max(res, height[i] < height[j] ? (j - i) * height[i++] : (j - i) * height[j--]);
...
//        List<String> list = letterCombinations("245");
//        System.out.print("[");
//        for (String s : list) {
//            System.out.print(s + ", ");
//        }
...
//        List<String> ans_6 = Arrays.asList(new String[]{"(((((())))))","((((()()))))","((((())())))","((((()))()))","((((())))())","((((()))))()","(((()(()))))","(((()()())))","(((()())()))","(((()()))())","(((()())))()","(((())(())))","(((())()()))","(((())())())","(((())()))()","(((()))(()))","(((()))()())","(((()))())()","(((())))(())","(((())))()()","((()((()))))","((()(()())))","((()(())()))","((()(()))())","((()(())))()","((()()(())))","((()()()()))","((()()())())","((()()()))()","((()())(()))","((()())()())","((()())())()","((()()))(())","((()()))()()","((())((())))","((())(()()))","((())(())())","((())(()))()","((())()(()))","((())()()())","((())()())()","((())())(())","((())())()()","((()))((()))","((()))(()())","((()))(())()","((()))()(())","((()))()()()","(()(((()))))","(()((()())))","(()((())()))","(()((()))())","(()((())))()","(()(()(())))","(()(()()()))","(()(()())())","(()(()()))()","(()(())(()))","(()(())()())","(()(())())()","(()(()))(())","(()(()))()()","(()()((())))","(()()(()()))","(()()(())())","(()()(()))()","(()()()(()))","(()()()()())","(()()()())()","(()()())(())","(()()())()()","(()())((()))","(()())(()())","(()())(())()","(()())()(())","(()())()()()","(())(((())))","(())((()()))","(())((())())","(())((()))()","(())(()(()))","(())(()()())","(())(()())()","(())(())(())","(())(())()()","(())()((()))","(())()(()())","(())()(())()","(())()()(())","(())()()()()","()((((()))))","()(((()())))","()(((())()))","()(((()))())","()(((())))()","()((()(())))","()((()()()))","()((()())())","()((()()))()","()((())(()))","()((())()())","()((())())()","()((()))(())","()((()))()()","()(()((())))","()(()(()()))","()(()(())())","()(()(()))()","()(()()(()))","()(()()()())","()(()()())()","()(()())(())","()(()())()()","()(())((()))","()(())(()())","()(())(())()","()(())()(())","()(())()()()","()()(((())))","()()((()()))","()()((())())","()()((()))()","()()(()(()))","()()(()()())","()()(()())()","()()(())(())","()()(())()()","()()()((()))","()()()(()())","()()()(())()","()()()()(())","()()()()()()"});
//
//        List<String> list = generateParenthesis(6);
//        System.out.println(list);
//
//        boolean flag = true;
//        if(ans_6.size() != list.size()) flag = false;
//        List<String> list1 = ans_6.stream().filter(s -> list.indexOf(s) == -1).collect(Collectors.toList());
//        List<String> list2 = list.stream().filter(s -> ans_6.indexOf(s) == -1).collect(Collectors.toList());
//
//        if(list1.size() > 0 || list2.size() > 0) flag = false;
//
//        System.out.println("答案：" + ans_6.size());
//        System.out.println("结果：" + list.size());
//
//        System.out.println("答案中有但结果中没有：" + list1);
//        System.out.println("结果中有但答案中没有：" + list2);
//
